...
public class NumberAxis extends ValueAxis 
     ...
     * @param area  the area within which the axes and data should be drawn
     *                  (<code>null</code> not permitted).
     * @param edge  the location of the axis relative to the plot 
     *              (<code>null</code> not permitted).
     ...
     * @param area  the area within which the axis is drawn.
    ...
    protected void drawTicks(Graphics2D g2, 
        ...
        while (iterator.hasNext()) {
            ...
            if (isTickLabelsVisible()) {
                ...
                //g2.drawLine((int) anchorPoint[0], (int) anchorPoint[1], (int) anchorPoint[0], (int) anchorPoint[1]);
   ...
   protected void selectHorizontalAutoTickUnit(Graphics2D g2,
    ...
    /**
     * Creates a list of ticks (including values and formatted labels) for the 
     * axis.
     *
     * @param g2  the graphics device.
