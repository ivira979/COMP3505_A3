	...
	public LegendItem getLegendItem(int datasetIndex, int series) {
        ...
        if (dataset != null) {
            if (getItemVisible(series, 0)) {
                ...
                AttributedString attributedLabel = llg.generateAttributedLabel(
                        dataset, series);
                ...
                if (attributedLabel != null) {
                    result = new LegendItem(attributedLabel, description, 
                            toolTipText, urlText, this.baseShapesVisible, 
                            shape, shapeFilled, paint, !shapeFilled, paint, 
                            lineStroke, this.plotLines, this.legendLine, 
