        ...
        if (dataset != null) {
            if (getItemVisible(series, 0)) {
                ...
                AttributedString attributedLabel 
                    = lg.generateAttributedLabel(dataset, series);
                ...
                if (attributedLabel != null) {
                    result = new LegendItem(attributedLabel, description, 
                            toolTipText, urlText, shapeIsVisible, shape, 
                            shapeIsFilled, fillPaint, shapeOutlineVisible, 
                            outlinePaint, outlineStroke, lineVisible, 
