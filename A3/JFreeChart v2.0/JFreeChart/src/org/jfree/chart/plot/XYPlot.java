 ...
 */
public class XYPlot extends Plot implements Block, ValueAxisPlot,
                                            Zoomable,
    ...
    /** 
     * A flag that controls whether or not the zero baseline is visible on
     * the main range axis.
     */
     ...
     * @param g2  the graphics device.
     * @param area  the area.
     * @param params  optional drawing parameters (ignored here).
     * 
