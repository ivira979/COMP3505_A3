...
public class PiePlot extends Plot implements Block, Cloneable, Serializable {
    ...
    public static final RectangleInsets DEFAULT_PADDING 
        = new RectangleInsets(UnitType.RELATIVE, 0.10, 0.10, 0.10, 0.10);
     ...
     * @param n the number of passes required.
     */
        ...
        while (iterator.hasNext()) {
            ...
            if (include) {
                ...
                AttributedString attributedLabel 
                        = llg.generateAttributedSectionLabel(this.dataset, key);
                ...
                if (attributedLabel != null) {
                    item = new LegendItem(attributedLabel, description, 
                            toolTipText, urlText, true, shape, true, paint, 
                            true, outlinePaint, outlineStroke, false, 
                            new Line2D.Float(), new BasicStroke(), Color.black);
                }
                else {
                    item = new LegendItem(label, description, toolTipText, 
                            urlText, true, shape, true, paint, true, 
                            outlinePaint, outlineStroke, false, 
                            new Line2D.Float(), new BasicStroke(), Color.black);
                }
