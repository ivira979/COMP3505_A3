 ...
 * a {@link Plot} and a {@link org.jfree.data.general.Dataset} (the plot in 
...
public class JFreeChart extends AbstractContentBlock 
        ...
        if (getBackgroundImage() != null) {
            ...
            g2.setComposite(
                AlphaComposite.getInstance(
                    AlphaComposite.SRC_OVER, getBackgroundImageAlpha()
                )
            );
            Rectangle2D dest = new Rectangle2D.Double(
                0.0, 0.0, getBackgroundImage().getWidth(null), 
                getBackgroundImage().getHeight(null)
            );
            Align.align(dest, chartArea, getBackgroundImageAlignment());
            g2.drawImage(
                getBackgroundImage(), (int) dest.getX(), (int) dest.getY(),
     ...
     * @return A rectangle.
     */
    protected Rectangle2D createAlignedRectangle2D(Size2D dimensions, 
